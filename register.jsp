                ...
                <div class="contact-section">
                    ...
                    <div class="contact-block">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="contactNumber" required placeholder="e.g. friend@email.com" title="Enter a valid email address">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="contact-block">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                <label>Email Address</label>
                                <input type="email" name="contactNumber" placeholder="e.g. friend@email.com" title="Enter a valid email address">
                            </div>
                        </div>
                    </div>
                </div>
